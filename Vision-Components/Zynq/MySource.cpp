...
PvResult MySource::QueueBuffer( PvBuffer *aBuffer )
{
    ...
    if ( mAcquisitionBuffer == NULL )
    {
        ...
        case PvPixelMono8: {
            ...
            uint8_t *cameraBuffer = camera_image_ptr();
            mAcquisitionBuffer->GetImage()->Attach(cameraBuffer, mWidth, mHeight, PvPixelMono8) ;
            break;
        }
        case PvPixelRGB16:
        case PvPixelRGBa16:
